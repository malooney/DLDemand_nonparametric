...
j <- 1
temp <- matrix(nrow=3, ncol = 4, 
  dimnames = list(c("meats_lnq1", "dairy_lnq2", "beans_lnq3"), c("meats", "dairy", "pulses", "income_elasticity"))
  )
...
dimnames(exx_np_wr2) <- list(c("meats_lnq1", "dairy_lnq2", "pulses_lnq3"), c("meats", "dairy", "beans", "income_elasticity", "R-squared"))
...
j <- 1
temp <- matrix(nrow=3, ncol = 4, 
  dimnames = list(c("meats_lnq1", "dairy_lnq2", "pulses_lnq3"), c("meats", "dairy", "beans", "income_elasticity"))
  )
