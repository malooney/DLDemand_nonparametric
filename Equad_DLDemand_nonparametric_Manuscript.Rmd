...
```{r Import & data manip, echo=FALSE, message=FALSE, cache=F}
...
```{r Single Equation Model Estimation using Log-Log Functional Form, echo=FALSE, message=FALSE, cache=F}
...
```{r, echo=FALSE, message=FALSE, results='asis', fig.height=3, cache=F}
