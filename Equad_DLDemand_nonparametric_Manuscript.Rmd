...
Consistent Model Specification Test [@Hsiao:2007uk]  
  
A kernel based test which tests for correct specification of the parametric form
...
$n{({\hat h_1},...,{\hat h_q})^{1/2}}{\hat I_n} \to N(0,\Omega )$ in distribution un $H_0$,  
