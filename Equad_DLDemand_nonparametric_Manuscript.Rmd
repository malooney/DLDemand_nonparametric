...
### bandwidth calculations ###
 bw.all_1 <- npregbw(formula = dld_1_formula, regtype = "ll", bwmethod = "cv.ls", bwtype="fixed", ckertype= "epanechnikov", data = Dta_sub_log)
bw.all_2 <- npregbw(formula = dld_2_formula, regtype = "ll", bwmethod = "cv.ls", bwtype="fixed", ckertype= "epanechnikov", data = Dta_sub_log)
bw.all_3 <- npregbw(formula = dld_3_formula, regtype = "ll", bwmethod = "cv.ls", bwtype="fixed", ckertype= "epanechnikov", data = Dta_sub_log)
# 
...
plot(density(model_1.np$grad[,1]), sub = "Meats - own price elasticity", main= "")
...
plot(density(model_2.np$grad[,2]), sub = "Dairy - own price elasticity", main= "")
...
plot(density(model_3.np$grad[,3]), sub = "Pulses - own price elasticity", main= "")
...
stargazer(exx_np, header=F, type="latex", summary = FALSE, font.size = "small", notes= c("***Significant at the 1 percent level,", "**Significant at the 5 percent level,", "*Significant at the 10 percent level."), notes.align= "r", flip = F, float = T, float.env = "table", title="non Parametric")

#stargazer(AIDS_H_elas_t_sig, header=F, type="latex", summary = FALSE, font.size = "small", notes= c("***Significant at the 1 percent level,", "**Significant at the 5 percent level,", "*Significant at the 10 percent level."), notes.align= "r", flip = F, float = T, float.env = "table", title="Full AIDS - Hicksian")
