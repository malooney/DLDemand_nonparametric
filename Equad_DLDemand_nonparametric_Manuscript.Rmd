...
For a reality check we have included an evaluation of the same data set considered in tables 2 and 3 and run this data through the Almost Ideal Demand System (AIDS). 
