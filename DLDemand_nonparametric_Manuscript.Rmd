...
# 
# saveRDS(cmsTest_1, file= "data/cmsTest_1.rds")
# saveRDS(cmsTest_2, file= "data/cmsTest_2.rds")
# saveRDS(cmsTest_3, file= "data/cmsTest_3.rds")
# saveRDS(cmsTest_4, file= "data/cmsTest_4.rds")
# saveRDS(cmsTest_5, file= "data/cmsTest_5.rds")
# saveRDS(cmsTest_6, file= "data/cmsTest_6.rds")

cmsTest_1 <- readRDS("data/cmsTest_1.rds")
cmsTest_2 <- readRDS("data/cmsTest_2.rds")
cmsTest_3 <- readRDS("data/cmsTest_3.rds")
cmsTest_4 <- readRDS("data/cmsTest_4.rds")
cmsTest_5 <- readRDS("data/cmsTest_5.rds")
cmsTest_6 <- readRDS("data/cmsTest_6.rds")
...
# 
# saveRDS(bw.all_1, file= "data/bw.all_1.rds")
# saveRDS(bw.all_2, file= "data/bw.all_2.rds")
# saveRDS(bw.all_3, file= "data/bw.all_3.rds")
# saveRDS(bw.all_4, file= "data/bw.all_4.rds")
# saveRDS(bw.all_5, file= "data/bw.all_5.rds")
# saveRDS(bw.all_6, file= "data/bw.all_6.rds")

bw.all_1 <- readRDS("data/bw.all_1.rds")
bw.all_2 <- readRDS("data/bw.all_2.rds")
bw.all_3 <- readRDS("data/bw.all_3.rds")
bw.all_4 <- readRDS("data/bw.all_4.rds")
bw.all_5 <- readRDS("data/bw.all_5.rds")
bw.all_6 <- readRDS("data/bw.all_6.rds")
...
# 
# saveRDS(KRS_test_1, file= "data/KRS_test_1.rds")
# saveRDS(KRS_test_2, file= "data/KRS_test_2.rds")
# saveRDS(KRS_test_3, file= "data/KRS_test_3.rds")
# saveRDS(KRS_test_4, file= "data/KRS_test_4.rds")
# saveRDS(KRS_test_5, file= "data/KRS_test_5.rds")
# saveRDS(KRS_test_6, file= "data/KRS_test_6.rds")

KRS_test_1 <- readRDS("data/KRS_test_1.rds")
KRS_test_2 <- readRDS("data/KRS_test_2.rds")
KRS_test_3 <- readRDS("data/KRS_test_3.rds")
KRS_test_4 <- readRDS("data/KRS_test_4.rds")
KRS_test_5 <- readRDS("data/KRS_test_5.rds")
KRS_test_6 <- readRDS("data/KRS_test_6.rds")
